...
var lexer = moo.compile({
    ...
    baseInstruction: ['ABS', 'ADD', 'ADDRESS', 'AMOUNT', 'AND', 'BALANCE', 'BLAKE2B', 'CAR', 'CAST', 'CDR', 'CHECK_SIGNATURE',
        ...
        /*'DIG',*/
        /*'DUG',*/ 'EMPTY_BIG_MAP', 'APPLY', 'CHAIN_ID'
    ],
...
var expandC_R = function(word, annot) {
    var expandedC_R = word.slice(1, -1).split('').map(function(c) {
        return (c === 'A' ? '{ "prim": "CAR" }' : '{ "prim": "CDR" }');
    });
    if (annot != null) {
...
var check_compare = function(cmp) {
...
var check_assert = function(assert) {
...
var check_if = function(ifStatement) {
...
var checkSetCadr = function(s) {
    return macroSETCADRconst.test(s);
};
var expandSetCadr = function(word, annot) {
 ...
 */
var stringToJson = function(d) {
    return "{ \"string\": " + d[0] + " }";
};
/**
 */
var bytesToJson = function(d) {
    return "{ \"bytes\": \"" + d[0].toString().slice(2) + "\" }";
};
/**
...
var keywordToJson = function(d) {
    ...
    if (d.length == 1) {
        ...
        var annot_1 = d[1].map(function(x) {
            return "\"" + x[1] + "\"";
        });
        if (checkKeyword(word)) {
 ...
 */
var singleArgKeywordToJson = function(d) {
    return "{ \"prim\": \"" + d[0] + "\", \"args\": [ " + d[2] + " ] }";
};
var comparableTypeToJson = function(d) {
    var annot = d[3].map(function(x) {
        return "\"" + x[1] + "\"";
    });
 ...
 * Also: (option (mutez))
 */
var singleArgKeywordWithParenToJson = function(d) {
 ...
 */
var doubleArgKeywordToJson = function(d) {
    return "{ \"prim\": \"" + d[0] + "\", \"args\": [ " + d[2] + ", " + d[4] + " ] }";
};
var doubleArgParenKeywordToJson = function(d) {
 ...
 * Example: "(Pair unit instruction)" -> "{ prim: Pair, args: [{prim: unit}, {prim: instruction}] }"
 */
var doubleArgKeywordWithParenToJson = function(d) {
 ...
 */
var tripleArgKeyWordToJson = function(d) {
 ...
 * Example: "(LAMBDA key unit {DIP;})" -> "{ prim: LAMBDA, args: [{prim: key}, {prim: unit}, {prim: DIP}] }"
 */
var tripleArgKeyWordWithParenToJson = function(d) {
    return "{ \"prim\": \"" + d[0] + "\", \"args\": [ " + d[2] + ", " + d[4] + ", " + d[6] + " ] }";
};
 ...
 * '{ prim: PAIR }' ]
 */
var instructionSetToJsonNoSemi = function(d) {
    return d[2].map(function(x) {
        return x[0];
    }).concat(d[3]).map(function(x) {
        return nestedArrayChecker(x);
    });
};
var instructionSetToJsonSemi = function(d) {
    return "" + d[2].map(function(x) {
        return x[0];
    }).map(function(x) {
        return nestedArrayChecker(x);
...
var dataListToJsonSemi = function(d) {
    return "[ " + d[2].map(function(x) {
        return x[0];
    }).map(function(x) {
        return nestedArrayChecker(x);
...
var dipnToJson = function(d) {
    return (d.length > 4) ? "{ \"prim\": \"" + d[0] + "\", \"args\": [ { \"int\": \"" + d[2] + "\" }, [ " + d[4] + " ] ] }" : "{ \"prim\": \"" + d[0] + "\", \"args\": [ " + d[2] + " ] }";
};
var dignToJson = function(d) {
    return "{ \"prim\": \"" + d[0] + "\", \"args\": [ { \"int\": \"" + d[2] + "\" } ] }";
};
var dropnToJson = function(d) {
    return "{ \"prim\": \"" + d[0] + "\", \"args\": [ { \"int\": \"" + d[2] + "\" } ] }";
};
var subContractToJson = function(d) {
    return "{ \"prim\":\"CREATE_CONTRACT\", \"args\": [ [ " + d[4] + ", " + d[6] + ", {\"prim\": \"code\" , \"args\":[ [ " + d[8] + " ] ] } ] ] }";
};
var instructionListToJson = function(d) {
    var instructionOne = [d[2]];
    var instructionList = d[3].map(function(x) {
        return x[3];
    });
    return instructionOne.concat(instructionList).map(function(x) {
        return nestedArrayChecker(x);
    });
};;;;;
var grammar = {
    ...
    ParserRules: [{
        ...
        },
        {
            ...
            "symbols": [(lexer.has("lparen") ? {
                type: "lparen"
            } : lparen), "_", (lexer.has("singleArgData") ? {
                type: "singleArgData"
            } : singleArgData), "_", "data", "_", (lexer.has("rparen") ? {
                type: "rparen"
            } : rparen)],
            "postprocess": singleArgKeywordWithParenToJson
        },
        ...
        },
        {
            ...
            "symbols": [(lexer.has("lparen") ? {
                type: "lparen"
            } : lparen), "_", (lexer.has("doubleArgData") ? {
                type: "doubleArgData"
            } : doubleArgData), "_", "data", "_", "data", "_", (lexer.has("rparen") ? {
                type: "rparen"
            } : rparen)],
            "postprocess": doubleArgKeywordWithParenToJson
        },
        ...
        },
        {
            ...
            "symbols": ["typeElt", "subTypeElt$ebnf$2$subexpression$1$ebnf$1", "_"]
        },
        {
        ...
        },
        {
            ...
            "symbols": ["typeElt", "subTypeElt$ebnf$2$subexpression$2$ebnf$1", "_"]
        },
        {
            "name": "subTypeElt$ebnf$2",
        ...
        {
            "name": "subTypeElt$ebnf$3$subexpression$1$ebnf$1",
            "symbols": [{
                "literal": ";"
            }],
            "postprocess": id
        ...
        {
            "name": "subTypeElt$ebnf$3$subexpression$1",
            "symbols": ["typeElt", "_", "subTypeElt$ebnf$3$subexpression$1$ebnf$1", "_"]
        },
        {
            "name": "subTypeElt$ebnf$3",
            "symbols": ["subTypeElt$ebnf$3$subexpression$1"]
        },
        {
            "name": "subTypeElt$ebnf$3$subexpression$2$ebnf$1",
            "symbols": [{
                "literal": ";"
            }],
            "postprocess": id
        ...
        {
            "name": "subTypeElt$ebnf$3$subexpression$2",
            "symbols": ["typeElt", "_", "subTypeElt$ebnf$3$subexpression$2$ebnf$1", "_"]
        },
        {
            "name": "subTypeElt$ebnf$3",
            "symbols": ["subTypeElt$ebnf$3", "subTypeElt$ebnf$3$subexpression$2"],
            "postprocess": function(d) {
                return d[0].concat([d[1]]);
            }
        },
        ...
        {
            "name": "subTypeElt$ebnf$4$subexpression$1$ebnf$1",
            "symbols": [{
                "literal": ";"
            }],
            "postprocess": id
        ...
        {
            "name": "subTypeElt$ebnf$4$subexpression$1",
            "symbols": ["typeElt", "_", "subTypeElt$ebnf$4$subexpression$1$ebnf$1", "_"]
        },
        {
            "name": "subTypeElt$ebnf$4",
            "symbols": ["subTypeElt$ebnf$4$subexpression$1"]
        },
        {
            "name": "subTypeElt$ebnf$4$subexpression$2$ebnf$1",
            "symbols": [{
                "literal": ";"
            }],
            "postprocess": id
        ...
        {
            "name": "subTypeElt$ebnf$4$subexpression$2",
            "symbols": ["typeElt", "_", "subTypeElt$ebnf$4$subexpression$2$ebnf$1", "_"]
        },
        {
            "name": "subTypeElt$ebnf$4",
            "symbols": ["subTypeElt$ebnf$4", "subTypeElt$ebnf$4$subexpression$2"],
            "postprocess": function(d) {
                return d[0].concat([d[1]]);
            }
        },
        ...
        },
        {
            ...
            "symbols": [{
                "literal": "DUP"
            }, "_", "instruction$ebnf$10", "_", "subInstruction"],
            "postprocess": dipnToJson
        },
        {
        ...
        {
            "name": "instruction$ebnf$11",
            "symbols": ["instruction$ebnf$11", /[0-9]/],
            "postprocess": function(d) {
                return d[0].concat([d[1]]);
            }
        },
        ...
        {
            "name": "subData$ebnf$1$subexpression$1$ebnf$1",
            "symbols": [{
                "literal": ";"
            }],
            "postprocess": id
        ...
        },
        {
            ...
            "symbols": ["data", "_", "subData$ebnf$1$subexpression$1$ebnf$1", "_"]
        },
        {
            "name": "subData$ebnf$1",
        ...
        {
            "name": "subData$ebnf$1$subexpression$2$ebnf$1",
            "symbols": [{
                "literal": ";"
            }],
            "postprocess": id
        ...
        },
        {
            ...
            "symbols": ["data", "_", "subData$ebnf$1$subexpression$2$ebnf$1", "_"]
        },
        {
            "name": "subData$ebnf$1",
        ...
        },
        {
            ...
            "symbols": ["data", "subData$ebnf$2$subexpression$1$ebnf$1", "_"]
        },
        {
            "name": "subData$ebnf$2",
        ...
        },
        {
            ...
            "symbols": ["data", "subData$ebnf$2$subexpression$2$ebnf$1", "_"]
        },
        {
            "name": "subData$ebnf$2",
        ...
        {
            "name": "subData$ebnf$3$subexpression$1$ebnf$1",
            "symbols": [{
                "literal": ";"
            }],
            "postprocess": id
        ...
        {
            "name": "subData$ebnf$3$subexpression$1",
            "symbols": ["data", "_", "subData$ebnf$3$subexpression$1$ebnf$1", "_"]
        },
        {
            "name": "subData$ebnf$3",
            "symbols": ["subData$ebnf$3$subexpression$1"]
        },
        {
            "name": "subData$ebnf$3$subexpression$2$ebnf$1",
            "symbols": [{
                "literal": ";"
            }],
            "postprocess": id
        ...
        {
            "name": "subData$ebnf$3$subexpression$2",
            "symbols": ["data", "_", "subData$ebnf$3$subexpression$2$ebnf$1", "_"]
        },
        {
            "name": "subData$ebnf$3",
            "symbols": ["subData$ebnf$3", "subData$ebnf$3$subexpression$2"],
            "postprocess": function(d) {
                return d[0].concat([d[1]]);
            }
        },
        ...
        {
            "name": "subData$ebnf$4$subexpression$1$ebnf$1",
            "symbols": [{
                "literal": ";"
            }],
            "postprocess": id
        ...
        {
            "name": "subData$ebnf$4$subexpression$1",
            "symbols": ["data", "subData$ebnf$4$subexpression$1$ebnf$1", "_"]
        },
        {
            "name": "subData$ebnf$4",
            "symbols": ["subData$ebnf$4$subexpression$1"]
        },
        {
            "name": "subData$ebnf$4$subexpression$2$ebnf$1",
            "symbols": [{
                "literal": ";"
            }],
            "postprocess": id
        ...
        {
            "name": "subData$ebnf$4$subexpression$2",
            "symbols": ["data", "subData$ebnf$4$subexpression$2$ebnf$1", "_"]
        },
        {
            "name": "subData$ebnf$4",
            "symbols": ["subData$ebnf$4", "subData$ebnf$4$subexpression$2"],
            "postprocess": function(d) {
                return d[0].concat([d[1]]);
            }
        },
        ...
        {
            "name": "subElt$ebnf$2$subexpression$1$ebnf$1",
            "symbols": [{
                "literal": ";"
            }],
            "postprocess": id
        ...
        {
            "name": "subElt$ebnf$2$subexpression$1",
            "symbols": ["elt", "subElt$ebnf$2$subexpression$1$ebnf$1", "_"]
        },
        {
            "name": "subElt$ebnf$2",
            "symbols": ["subElt$ebnf$2$subexpression$1"]
        },
        {
            "name": "subElt$ebnf$2$subexpression$2$ebnf$1",
            "symbols": [{
                "literal": ";"
            }],
            "postprocess": id
        ...
        {
            "name": "subElt$ebnf$2$subexpression$2",
            "symbols": ["elt", "subElt$ebnf$2$subexpression$2$ebnf$1", "_"]
        },
        {
            "name": "subElt$ebnf$2",
            "symbols": ["subElt$ebnf$2", "subElt$ebnf$2$subexpression$2"],
            "postprocess": function(d) {
                return d[0].concat([d[1]]);
            }
        },
