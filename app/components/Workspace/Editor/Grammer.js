...
var macroDIPconst = /DII+P/;
var macroDUPconst = /DUU+P/;
var DIPmatcher = new RegExp(macroDIPconst);
var DUPmatcher = new RegExp(macroDUPconst);
var macroASSERTlistConst = ['ASSERT', 'ASSERT_EQ', 'ASSERT_NEQ', 'ASSERT_GT', 'ASSERT_LT', 'ASSERT_GE', 'ASSERT_LE', 'ASSERT_NONE', 'ASSERT_SOME', 'ASSERT_LEFT', 'ASSERT_RIGHT', 'ASSERT_CMPEQ', 'ASSERT_CMPNEQ', 'ASSERT_CMPGT', 'ASSERT_CMPLT', 'ASSERT_CMPGE', 'ASSERT_CMPLE'];
var macroIFCMPlist = ['IFCMPEQ', 'IFCMPNEQ', 'IFCMPLT', 'IFCMPGT', 'IFCMPLE', 'IFCMPGE'];
...
var checkC_R = function (c_r) {
    var pattern = new RegExp('^C(A|D)(A|D)+R$'); // TODO
    return pattern.test(c_r);
};
var expandC_R = function (word, annot) {
    var expandedC_R = word.slice(1, -1).split('').map(function (c) { return (c === 'A' ? '{ "prim": "CAR" }' : '{ "prim": "CDR" }'); });
    if (annot != null) {
        var lastChar = word.slice(-2, -1);
        if (lastChar === 'A') {
...
var check_compare = function (cmp) { return macroCMPlist.includes(cmp); };
var expand_cmp = function (cmp, annot) {
...
var check_dup = function (dup) { return DUPmatcher.test(dup); };
var expand_dup = function (dup, annot) {
    var t = '';
...
var check_assert = function (assert) { return macroASSERTlistConst.includes(assert); };
var expand_assert = function (assert, annot) {
    var annotation = !!annot ? ", \"annots\": [" + annot + "]" : '';
    switch (assert) {
        case 'ASSERT':
...
var check_fail = function (fail) { return fail === "FAIL"; };
var expand_fail = function (fail, annot) {
    if (annot == null) {
...
var check_if = function (ifStatement) { return (macroIFCMPlist.includes(ifStatement) || macroIFlist.includes(ifStatement) || ifStatement === 'IF_SOME'); }; // TODO: IF_SOME
var expandIF = function (ifInstr, ifTrue, ifFalse, annot) {
    var annotation = !!annot ? ", \"annots\": [" + annot + "]" : '';
    switch (ifInstr) {
        case 'IFCMPEQ':
...
var check_dip = function (dip) { return DIPmatcher.test(dip); };
var expandDIP = function (dip, instruction, annot) {
    var t = '';
...
var check_other = function (word) { return (word === "UNPAIR" || word === "UNPAPAIR"); }; // TODO: dynamic matching
...
var expand_other = function (word, annot) {
    if (word === 'UNPAIR') {
        if (annot == null) {
...
var checkSetCadr = function (s) { return macroSETCADRconst.test(s); };
var expandSetCadr = function (word, annot) { return nestSetCadr(word.slice(5, -1)); };
var nestSetCadr = function (r) {
    if (r.length === 0) {
        return '';
    }
    var c = r.charAt(0);
...
var checkKeyword = function (word) {
...
var expandKeyword = function (word, annot) {
    if (checkC_R(word)) {
 ...
 * Example: "3" -> { "int": "3" }
 */
var intToJson = function (d) { return "{ \"int\": \"" + parseInt(d[0]) + "\" }"; };
/**
 * Given a string, convert it to JSON.
 * Example: "string" -> "{ "string": "blah" }"
 */
var stringToJson = function (d) { return "{ \"string\": " + d[0] + " }"; };
/**
*/
var bytesToJson = function (d) { return "{ \"bytes\": \"" + d[0].toString().slice(2) + "\" }"; };
/**
 * Given a keyword, convert it to JSON.
 * Example: "int" -> "{ "prim" : "int" }"
 */
var keywordToJson = function (d) {
    ...
    if (d.length === 1) {
        ...
        var annot_1 = d[1].map(function (x) { return "\"" + x[1] + "\""; });
        if (checkKeyword(word)) {
            return [expandKeyword(word, annot_1)];
        }
        else {
            return "{ \"prim\": \"" + d[0] + "\", \"annots\": [" + annot_1 + "] }";
        }
    }
};
/**
 ...
 */
var singleArgKeywordToJson = function (d) { return "{ \"prim\": \"" + d[0] + "\", \"args\": [ " + d[2] + " ] }"; };
var comparableTypeToJson = function (d) {
    var annot = d[3].map(function (x) { return "\"" + x[1] + "\""; });
    return "{ \"prim\": \"" + d[2] + "\", \"annots\": [" + annot + "]  }";
};
var singleArgTypeKeywordWithParenToJson = function (d) {
    var annot = d[3].map(function (x) { return "\"" + x[1] + "\""; });
    return "{ \"prim\": \"" + d[2] + "\", \"args\": [ " + d[5] + " ], \"annots\": [" + annot + "]  }";
};
var singleArgInstrKeywordToJson = function (d) {
    var word = "" + d[0].toString();
    if (check_dip(word)) {
...
var singleArgTypeKeywordToJson = function (d) {
    var word = "" + d[0].toString();
    var annot = d[1].map(function (x) { return "\"" + x[1] + "\""; });
    if (check_dip(word)) {
 ...
 * Also: (option (mutez))
 */
var singleArgKeywordWithParenToJson = function (d) { return "{ \"prim\": \"" + d[2] + "\", \"args\": [ " + d[(4 + ((d.length === 7) ? 0 : 2))] + " ] }"; };
/**
 ...
 */
var doubleArgKeywordToJson = function (d) { return "{ \"prim\": \"" + d[0] + "\", \"args\": [ " + d[2] + ", " + d[4] + " ] }"; };
var doubleArgParenKeywordToJson = function (d) { return "{ \"prim\": \"" + d[0] + "\", \"args\": [ " + d[4] + ", " + d[8] + " ] }"; };
var doubleArgInstrKeywordToJson = function (d) {
    var word = "" + d[0].toString();
    if (check_if(word)) {
 ...
 * Example: "(Pair unit instruction)" -> "{ prim: Pair, args: [{prim: unit}, {prim: instruction}] }"
 */
var doubleArgKeywordWithParenToJson = function (d) { return "{ \"prim\": \"" + d[2] + "\", \"args\": [ " + d[4] + ", " + d[6] + " ] }"; };
/**
 ...
 */
var tripleArgKeyWordToJson = function (d) { return "{ \"prim\": \"" + d[0] + "\", \"args\": [ " + d[2] + ", " + d[4] + ", [" + d[6] + "] ] }"; };
/**
 * Given a keyword with three arguments and parentheses, convert it into JSON.
 * Example: "(LAMBDA key unit {DIP;})" -> "{ prim: LAMBDA, args: [{prim: key}, {prim: unit}, {prim: DIP}] }"
 */
var tripleArgKeyWordWithParenToJson = function (d) { return "{ \"prim\": \"" + d[0] + "\", \"args\": [ " + d[2] + ", " + d[4] + ", " + d[6] + " ] }"; };
var nestedArrayChecker = function (x) {
 ...
 * '{ prim: PAIR }' ]
 */
var instructionSetToJsonNoSemi = function (d) { return d[2].map(function (x) { return x[0]; }).concat(d[3]).map(function (x) { return nestedArrayChecker(x); }); };
var instructionSetToJsonSemi = function (d) { return "" + d[2].map(function (x) { return x[0]; }).map(function (x) { return nestedArrayChecker(x); }); };
var dataListToJsonSemi = function (d) { return "[ " + d[2].map(function (x) { return x[0]; }).map(function (x) { return nestedArrayChecker(x); }) + " ]"; };
/**
 * parameter, storage, code
 */
var scriptToJson = function (d) { return "[ " + d[0] + ", " + d[2] + ", { \"prim\": \"code\", \"args\": [ [ " + d[4] + " ] ] } ]"; };
var doubleArgTypeKeywordToJson = function (d) {
    var annot = d[1].map(function (x) { return "\"" + x[1] + "\""; });
    return "{ \"prim\": \"" + d[0] + "\", \"args\": [ " + d[4] + ", " + d[6] + " ], \"annots\": [" + annot + "]  }";
};
var doubleArgTypeKeywordWithParenToJson = function (d) {
    var annot = d[3].map(function (x) { return "\"" + x[1] + "\""; });
    return "{ \"prim\": \"" + d[2] + "\", \"args\": [ " + d[5] + ", " + d[7] + " ], \"annots\": [" + annot + "]  }";
};
var tripleArgTypeKeyWordToJson = function (d) {
    var annot = d[1].map(function (x) { return "\"" + x[1] + "\""; });
    return "{ \"prim\": \"" + d[0] + "\", \"args\": [ " + d[3] + ", " + d[5] + ", " + d[7] + " ], \"annots\": [" + annot + "]  }";
};
var pushToJson = function (d) {
    return "{ \"prim\": \"" + d[0] + "\", \"args\": [" + d[2] + ", []] }";
};
var pushWithAnnotsToJson = function (d) {
    var annot = d[1].map(function (x) { return "\"" + x[1] + "\""; });
    return "{ \"prim\": \"PUSH\", \"args\": [ " + d[3] + ", " + d[5] + " ], \"annots\": [" + annot + "]  }";
};
var dipnToJson = function (d) { return (d.length > 4) ? "{ \"prim\": \"" + d[0] + "\", \"args\": [ { \"int\": \"" + d[2] + "\" }, [ " + d[4] + " ] ] }" : "{ \"prim\": \"" + d[0] + "\", \"args\": [ " + d[2] + " ] }"; };
var dupnToJson = function (d) {
    var n = Number(d[2]);
    if (n === 1) {
        return '{ "prim": "DUP" }';
    }
...
var dignToJson = function (d) { return "{ \"prim\": \"" + d[0] + "\", \"args\": [ { \"int\": \"" + d[2] + "\" } ] }"; };
var dropnToJson = function (d) { return "{ \"prim\": \"" + d[0] + "\", \"args\": [ { \"int\": \"" + d[2] + "\" } ] }"; };
var subContractToJson = function (d) { return "{ \"prim\":\"CREATE_CONTRACT\", \"args\": [ [ " + d[4] + ", " + d[6] + ", {\"prim\": \"code\" , \"args\":[ [ " + d[8] + " ] ] } ] ] }"; };
var instructionListToJson = function (d) {
    var instructionOne = [d[2]];
    var instructionList = d[3].map(function (x) { return x[3]; });
    return instructionOne.concat(instructionList).map(function (x) { return nestedArrayChecker(x); });
};
;
;
;
...
var grammar = {
    ...
    ParserRules: [
        ...
        { "name": "type$ebnf$1", "symbols": ["type$ebnf$1", "type$ebnf$1$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "type$ebnf$2", "symbols": ["type$ebnf$2", "type$ebnf$2$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "type$ebnf$3", "symbols": ["type$ebnf$3", "type$ebnf$3$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "type$ebnf$4", "symbols": ["type$ebnf$4", "type$ebnf$4$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "type$ebnf$5", "symbols": ["type$ebnf$5", "type$ebnf$5$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "type$ebnf$6", "symbols": ["type$ebnf$6", "type$ebnf$6$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "subData$ebnf$1", "symbols": ["subData$ebnf$1", "subData$ebnf$1$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "subData$ebnf$2$subexpression$1$ebnf$1", "symbols": [], "postprocess": function () { return null; } },
        ...
        { "name": "subData$ebnf$2$subexpression$2$ebnf$1", "symbols": [], "postprocess": function () { return null; } },
        { "name": "subData$ebnf$2$subexpression$2", "symbols": ["data", "_", "subData$ebnf$2$subexpression$2$ebnf$1", "_"] },
        { "name": "subData$ebnf$2", "symbols": ["subData$ebnf$2", "subData$ebnf$2$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "subElt$ebnf$1$subexpression$1$ebnf$1", "symbols": [], "postprocess": function () { return null; } },
        ...
        { "name": "subElt$ebnf$1$subexpression$2$ebnf$1", "symbols": [], "postprocess": function () { return null; } },
        { "name": "subElt$ebnf$1$subexpression$2", "symbols": ["elt", "subElt$ebnf$1$subexpression$2$ebnf$1", "_"] },
        { "name": "subElt$ebnf$1", "symbols": ["subElt$ebnf$1", "subElt$ebnf$1$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "subTypeData$ebnf$1$subexpression$1$ebnf$1", "symbols": [], "postprocess": function () { return null; } },
        ...
        { "name": "subTypeData$ebnf$1$subexpression$2$ebnf$1", "symbols": [], "postprocess": function () { return null; } },
        { "name": "subTypeData$ebnf$1$subexpression$2", "symbols": ["data", "subTypeData$ebnf$1$subexpression$2$ebnf$1", "_"] },
        { "name": "subTypeData$ebnf$1", "symbols": ["subTypeData$ebnf$1", "subTypeData$ebnf$1$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "subTypeData$ebnf$2$subexpression$1$ebnf$1", "symbols": [], "postprocess": function () { return null; } },
        ...
        { "name": "subTypeData$ebnf$2$subexpression$2$ebnf$1", "symbols": [], "postprocess": function () { return null; } },
        { "name": "subTypeData$ebnf$2$subexpression$2", "symbols": ["data", "subTypeData$ebnf$2$subexpression$2$ebnf$1", "_"] },
        { "name": "subTypeData$ebnf$2", "symbols": ["subTypeData$ebnf$2", "subTypeData$ebnf$2$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "subTypeElt$ebnf$1$subexpression$1$ebnf$1", "symbols": [], "postprocess": function () { return null; } },
        ...
        { "name": "subTypeElt$ebnf$1$subexpression$2$ebnf$1", "symbols": [], "postprocess": function () { return null; } },
        { "name": "subTypeElt$ebnf$1$subexpression$2", "symbols": ["typeElt", "subTypeElt$ebnf$1$subexpression$2$ebnf$1", "_"] },
        { "name": "subTypeElt$ebnf$1", "symbols": ["subTypeElt$ebnf$1", "subTypeElt$ebnf$1$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "subTypeElt$ebnf$2$subexpression$1$ebnf$1", "symbols": [], "postprocess": function () { return null; } },
        ...
        { "name": "subTypeElt$ebnf$2$subexpression$2$ebnf$1", "symbols": [], "postprocess": function () { return null; } },
        { "name": "subTypeElt$ebnf$2$subexpression$2", "symbols": ["typeElt", "_", "subTypeElt$ebnf$2$subexpression$2$ebnf$1", "_"] },
        { "name": "subTypeElt$ebnf$2", "symbols": ["subTypeElt$ebnf$2", "subTypeElt$ebnf$2$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "subInstruction$ebnf$1", "symbols": ["subInstruction$ebnf$1", "subInstruction$ebnf$1$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "subInstruction$ebnf$2", "symbols": ["subInstruction$ebnf$2", "subInstruction$ebnf$2$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "instruction$ebnf$1", "symbols": ["instruction$ebnf$1", "instruction$ebnf$1$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "instruction$ebnf$2", "symbols": ["instruction$ebnf$2", "instruction$ebnf$2$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "instruction$ebnf$3", "symbols": ["instruction$ebnf$3", "instruction$ebnf$3$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "instruction$ebnf$4", "symbols": ["instruction$ebnf$4", "instruction$ebnf$4$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "instruction$ebnf$5", "symbols": ["instruction$ebnf$5", "instruction$ebnf$5$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "instruction$ebnf$6", "symbols": ["instruction$ebnf$6", "instruction$ebnf$6$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "instruction$ebnf$7", "symbols": ["instruction$ebnf$7", "instruction$ebnf$7$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "instruction$ebnf$8", "symbols": ["instruction$ebnf$8", "instruction$ebnf$8$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "instruction$ebnf$9", "symbols": ["instruction$ebnf$9", /[0-9]/], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "instruction$ebnf$10", "symbols": ["instruction$ebnf$10", /[0-9]/], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "instruction$ebnf$11", "symbols": ["instruction$ebnf$11", "instruction$ebnf$11$subexpression$2"], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        { "name": "instruction", "symbols": [{ "literal": "DUP" }, "instruction$ebnf$11", "_"], "postprocess": keywordToJson },
        { "name": "instruction$ebnf$12", "symbols": [/[0-9]/] },
        { "name": "instruction$ebnf$12", "symbols": ["instruction$ebnf$12", /[0-9]/], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        { "name": "instruction", "symbols": [{ "literal": "DIG" }, "_", "instruction$ebnf$12"], "postprocess": dignToJson },
        { "name": "instruction$ebnf$13", "symbols": [/[0-9]/] },
        { "name": "instruction$ebnf$13", "symbols": ["instruction$ebnf$13", /[0-9]/], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        { "name": "instruction", "symbols": [{ "literal": "DUG" }, "_", "instruction$ebnf$13"], "postprocess": dignToJson },
        { "name": "instruction$ebnf$14", "symbols": [/[0-9]/] },
        { "name": "instruction$ebnf$14", "symbols": ["instruction$ebnf$14", /[0-9]/], "postprocess": function (d) { return d[0].concat([d[1]]); } },
        ...
        { "name": "semicolons$ebnf$1", "symbols": [], "postprocess": function () { return null; } },
