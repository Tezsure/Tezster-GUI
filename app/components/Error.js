    ...
    return (
      <div className="main-container">
        <div className="workplace-container">
          <div className="logo-container" style={{ height: '40px' }}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={100}
              height={100}
              viewBox="0 0 88.31 21.676"
            >
              <g
                id="Group_40"
                data-name="Group 40"
                transform="translate(-84.52 503.123)"
              >
                <path
                  id="Path_2245"
                  data-name="Path 2245"
                  d="M290.8-417.555a5.726,5.726,0,0,0,5.008,5.163,5.35,5.35,0,0,0,5.4-2.532.978.978,0,0,1,1.521-.34.919.919,0,0,1,.216,1.235,7.275,7.275,0,0,1-5.124,3.5,7.392,7.392,0,0,1-5.849-1.345,7.532,7.532,0,0,1-2.955-4.7,8.755,8.755,0,0,1,1.241-6.881,6.894,6.894,0,0,1,5.323-3.146,6.971,6.971,0,0,1,6.2,2.41,7.837,7.837,0,0,1,1.826,4.118,12.314,12.314,0,0,1,.128,1.367,1.022,1.022,0,0,1-1.141,1.158H290.8Zm10.926-1.944a5.439,5.439,0,0,0-5.5-5.271c-2.906.1-5.573,2.688-5.421,5.271Z"
                  transform="translate(-190.745 -71.319)"
                  fill="#00c68e"
                />
                <path
                  id="Path_2246"
                  data-name="Path 2246"
                  d="M1063.075-417.622a5.743,5.743,0,0,0,5.125,5.233,5.409,5.409,0,0,0,5.378-2.616.936.936,0,0,1,1.33-.344.931.931,0,0,1,.275,1.345,7.246,7.246,0,0,1-6.517,3.525,7,7,0,0,1-6.475-3.909,8.5,8.5,0,0,1,.689-9.48,7.24,7.24,0,0,1,12.3,1.4,9.123,9.123,0,0,1,.821,3.714.978.978,0,0,1-1.112,1.132h-11.819Zm10.985-1.908a5.7,5.7,0,0,0-2.736-4.554,5.234,5.234,0,0,0-5.764.22,5.822,5.822,0,0,0-2.5,4.333Z"
                  transform="translate(-912.348 -71.289)"
                  fill="#00c68e"
                />
                <path
                  id="Path_2247"
                ...
                <path
                  id="Path_2251"
                  data-name="Path 2251"
                  d="M1316.418-424.476c.137-.113.21-.17.278-.231a6.374,6.374,0,0,1,4.291-1.683.939.939,0,0,1,1.054.883.918.918,0,0,1-.973.965,4.746,4.746,0,0,0-4.641,4.969c-.021,2.775-.005,5.551-.008,8.326a.954.954,0,0,1-.637,1,.916.916,0,0,1-1.2-.7,1.78,1.78,0,0,1-.026-.358q0-7,0-14c0-.711.445-1.164,1.05-1.076a.916.916,0,0,1,.806.892C1316.428-425.178,1316.418-424.867,1316.418-424.476Z"
                  transform="translate(-1149.212 -71.557)"
                  fill="#00c68e"
                />
                <path
                  id="Path_2252"
                  data-name="Path 2252"
                  d="M201.218-381.19H200.1v-3.638h1.122Zm-.766-3.29v2.92h.407v-2.92Z"
                  transform="translate(-107.855 -110.395)"
                  fill="#00c68e"
                  stroke="#00c68e"
                  strokeWidth="0.1"
                />
                <path
                  id="Path_2253"
                  data-name="Path 2253"
                  d="M200.806-410.14a.556.556,0,0,0-.556.556.556.556,0,0,0,.556.556.556.556,0,0,0,.556-.556A.556.556,0,0,0,200.806-410.14Zm0,.77a.214.214,0,0,1-.215-.214.215.215,0,0,1,.215-.215.215.215,0,0,1,.215.215A.214.214,0,0,1,200.8-409.37Z"
                  transform="translate(-107.999 -86.743)"
                  fill="#00c68e"
                  stroke="#00c68e"
                  strokeWidth="0.1"
                />
                <path
                  id="Path_2254"
                  data-name="Path 2254"
                  d="M200.9-435.25a.555.555,0,0,0-.556.556.555.555,0,0,0,.556.556.555.555,0,0,0,.556-.556A.555.555,0,0,0,200.9-435.25Zm0,.77a.215.215,0,0,1-.215-.215.214.214,0,0,1,.215-.214.214.214,0,0,1,.215.214A.215.215,0,0,1,200.9-434.48Z"
                  transform="translate(-108.083 -63.28)"
                  fill="#00c68e"
                  stroke="#00c68e"
                  strokeWidth="0.1"
                />
          ...
          <div className="description-container">
            ...
            >
              <b>While we fetch information about your last session.</b>
            </p>
          </div>
        </div>
      </div>
